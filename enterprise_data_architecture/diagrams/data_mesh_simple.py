...
# Create the diagram
with Diagram("Data Mesh Architecture", show=False, direction="TB", filename="data_mesh_simple"):
    ...
    with Cluster("Discovery & Governance"):
        catalog = PostgreSQL("Data Catalog")
        governance = MongoDB("Governance")
    ...
    with Cluster("Domain: Marketing"):
        with Cluster("Marketing Domain Data Product"):
            ...
            marketing_compute = Spark("Marketing Analytics")
    ...
    with Cluster("Domain: Finance"):
        with Cluster("Finance Domain Data Product"):
            ...
            finance_compute = Spark("Finance Analytics")
    ...
    # Connect domains to governance, catalog and users
